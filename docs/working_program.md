...
| № | Раздел или тема | Всего | Л | ЛР | СРС | Индикаторы |
|---:|---|---:|---:|---:|---:|---|
| 1 | Постановка задачи классификации, типы признаков и этапы решения | 6 | 2 | 2 | 2 | ML-2.1, ML-2.2 |
| 2 | Метрики, матрица ошибок, ROC/PR, кросс-валидация | 6 | 2 | 2 | 2 | ML-2.3 |
| 3 | Логистическая регрессия и регуляризация | 6 | 1 | 1 | 4 | ML-3.1, ML-3.3 |
| 4 | SVM, разделяющая гиперплоскость и ядра | 6 | 1 | 1 | 4 | ML-3.1, ML-3.3 |
| 5 | Деревья решений, критерии разбиения и контроль сложности | 4 | 1 | 1 | 2 | ML-3.1, ML-3.3 |
| 6 | Bagging и Random Forest | 4 | 1 | 1 | 2 | ML-3.2, ML-3.3 |
| 7 | Boosting: AdaBoost, Gradient Boosting, XGBoost, LightGBM, CatBoost | 6 | 1 | 1 | 4 | ML-3.2, ML-3.3 |
| 8 | Дисбаланс классов и feature engineering | 5 | 1 | 1 | 3 | ML-2.2, ML-2.3 |
| 9 | MLP для классификации табличных данных | 10 | 2 | 2 | 6 | DL-1.1, DL-1.2 |
| 10 | CNN и transfer learning для классификации изображений | 10 | 2 | 2 | 6 | DL-1.3, DL-1.4 |
| 11 | Прикладные кейсы, SHAP/LIME и анализ ошибок | 6,8 | 2 | 2 | 2,8 | ML-2.3, ML-3.3, DL-1.3 |
...
Подробные задания и критерии приведены в [комплекте лабораторных работ](../src/kims/laboratory_works.md).
...
- текущие вопросы и мини-задания;
- лабораторные работы;
- рубежный контроль по данным и сравнению моделей;
- сквозной проект и peer-review;
- зачёт в форме защиты проекта и ответов на вопросы.

Полное соответствие индикаторов, КИМ и ресурсов представлено в [модели измерения](measurement_model.md).
...
- [критерии проекта](project_criteria.md);
- [регламент peer-review](peer_review.md);
- [критерии защиты](commission_criteria.md).
...
Аннотации и назначение источников приведены в [каталоге литературы](../resources/literature.md).
